...
Last updated: Phase 0 (continua - more premium polish for elegir perfiles: 'en vivo' badge in recs header, 'disponibles ahora' consistency, inline lastSync next to Actualizar + recs, calmer texts, empty states, filters declutter, spinners, lastSyncs. Builds/pushes (2f66d27). **PHASE 0 SIGN-OFF READY** (continua).
