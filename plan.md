...
**Current status (this continuation)**: Phase 0 core is solid (profile save + chat real-time with onSnapshot/bg polls/refresh btns/lastSync updates; polished empty states; previous fixes). Pushes ongoing (latest 19b2196). Hard refresh + test. Ready for sign-off.
