...
**Versión cierre:** v0.1.377 · **Estado:** ✅ jun 2026
...
| 378 | Fuel mounts | `FuelSetupWizard` + `FuelLogModal` mounts | ☐ |
| 379 | Piloto LIVE manual | Ejecución sábado + screenshots Play | ☐ |
| 380 | QA 17 ítems | `betaReleaseChecklist` en 2 dispositivos | ☐ |
