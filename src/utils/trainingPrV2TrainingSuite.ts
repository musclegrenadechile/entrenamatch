...
export const TRAINING_PR_V2_TRAINING_UTILS: readonly TrainingPrV2TrainingUtilEntry[] = [
  ...
  {
    id: 'mega-flow-pr-coverage',
    module: 'e2eTrainingMegaFlowPrCoverage',
    oleada: 452,
    covers: ['pr', 'e2e', 'inventory'],
  },
  {
  ...
  {
    id: 'pr-v2-post-mega-polish',
    module: 'trainingPolishPrV2PostMegaSuite',
    oleada: 453,
    covers: ['pr', 'closure'],
  },
  {
  ...
  {
    id: 'playwright-pr-smoke',
    module: 'e2eTrainingPlaywrightPrSmokeCoverage',
    oleada: 453,
    covers: ['pr', 'e2e', 'inventory'],
  },
] as const
