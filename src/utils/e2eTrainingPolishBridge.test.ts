...
describe('e2eTrainingPolishBridge', () => {
  it('define puente E2E ↔ pulido', () => {
    expect(countE2ETrainingPolishBridgeEntries()).toBe(21)
  ...
  it('trainingMegaBlockRange 361–409', () => {
    expect(trainingMegaBlockRange()).toEqual({ from: 361, to: 409 })
  })

  it('uniqueE2EValidatedPolishOleadas y e2eBridgeEntriesForOleada', () => {
    expect(uniqueE2EValidatedPolishOleadas()).toEqual([
      384, 386, 388, 391, 392, 393, 394, 395, 396, 397, 401, 404, 405, 406, 407, 408, 409,
    ])
