...
describe('e2eFuelPlanFullCoverage', () => {
  it('unifica 12 suites E2E Fuel×EntrenaPlan (oleada 420–434)', () => {
    expect(countFuelPlanCoverageSuites()).toBe(12)
    expect(e2eFuelPlanFullBlockRange()).toEqual({ from: 412, to: 434 })
