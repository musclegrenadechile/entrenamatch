    ...
    if (this.state.error) {
      ...
      return (
        <div className="flex-1 flex flex-col items-center justify-center p-8 text-center">
          ...
          {staleChunk ? (
            <p className="text-[11px] text-[#9CA3AF] mt-2 max-w-[280px] leading-relaxed">
              Hay una versión nueva de EntrenaMatch. Recarga para descargar los archivos actualizados.
            </p>
          ) : (
          ...
          >
            {staleChunk ? 'Actualizar app' : 'Reintentar'}
          </button>
        </div>
      )
    }
