...
import { ProfileHeroExtras } from './ProfileHeroExtras'
...
export function ProfileTab(props: ProfileTabProps) {
  const { profileSection, setProfileSection } = profileTabBindings(props)
  ...
  return (
    <div className="flex-1 overflow-auto em-v2-profile pb-28">
