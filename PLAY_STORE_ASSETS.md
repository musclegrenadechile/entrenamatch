...
**Current version for this upload**: versionCode 13 / 0.1.10-prealpha (next AAB will be 0.1.11 Arena Edition). **PREVIOUS JSON FIXED + GIANT UX + NOW THE "NADIE LO HA VISTO" UNIQUE WAVE**: After full autonomy "te doy autorizacion completa... hace esta aplicacion algo que nadie haya visto algo unico", delivered a complete disruptive never-before-seen layer on the EntrenaSync core:
