...
**1:1 messaging fully working (2025-04)**: Sesiones + group + 1:1 real entre cuentas live y cross-device. UI declutter + premium polish para elegir perfiles (top bar suave, premium banners/empty states con lastSync en Explore/Sessions/Matches/Profile, calmer real sync text, recs cleaned, spinner en Sincronizar, lastSync headers consistent 'en vivo', filters modal cleaned). lastSync "hace Xs" visible + Actualizar. Hard refresh después de pushes.
