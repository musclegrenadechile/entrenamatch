...
- UI ultra-limpia para elegir perfiles: botones flotantes removidos, 'Desliza' hint quitado, empty states mejorados (Explorar con 'Actualizar reales' directo, Sesiones suavizado), textos guía eliminados. Premium al elegir perfiles reales. Hard refresh.
