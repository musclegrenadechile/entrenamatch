...
- UI ultra-limpia para elegir perfiles: botones flotantes removidos, 'Desliza' hint quitado, recomendaciones con badges REAL, título 'reales primero' y distancia, lastSync 'hace Xs' en header (solo real mode); empty states mejorados; notas demo en squads removidas para UI más limpia. Premium al elegir perfiles reales. Hard refresh.
