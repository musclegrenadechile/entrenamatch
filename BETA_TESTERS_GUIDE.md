...
- UI ultra-limpia para elegir perfiles: botones flotantes removidos, 'Desliza' hint en tarjetas swipe quitado, textos guía suavizados en Explorar (header, empty state, recomendaciones), Matches empty, etc. Foco premium al swippear perfiles reales. Hard refresh post-push.
