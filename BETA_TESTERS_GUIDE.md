...
- UI ultra-limpia para elegir perfiles: botones flotantes removidos, 'Desliza' hint quitado, recomendaciones con badges REAL, título 'reales primero' y distancia, lastSync 'hace Xs' en header; empty states mejorados con update directo. Textos guía eliminados. Premium al elegir perfiles reales. Hard refresh.
