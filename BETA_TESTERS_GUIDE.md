...
- **Mapa en vivo "sigue con todo" ultra pulido (precioso + único)**: (v0.1.20+)
  ...
  - Legend ahora interactivo: toca una zona (Viña, Stgo, etc.) para filtrar el mapa solo a esa ciudad. Toca de nuevo o "✕ todas" para reset. Perfecto para "sigue con todo el mapa".
