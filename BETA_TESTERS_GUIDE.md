...
- UI ultra-limpia para elegir perfiles: botones flotantes removidos, 'Desliza' hint quitado, empty state mejorado con botón directo 'Actualizar reales', textos suavizados. Foco premium al elegir perfiles reales. Hard refresh.
